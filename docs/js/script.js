...
$(document).ready(function() {
    $('.slider').slick({
        ...
        adaptiveHeight: true, // Автоматическая адаптивная высота слайдера (true/false) (не забываем про изменения в стилях .slider-track - align items: flex-start;)
        ...
        infinite: true, // Бесконечность прокрутки слайдов (true/false)
        initialSlide: 0, // Стартовый слайд (Номер слайда)
        autoplay: false, // Автоматическая прокрутка слайдов (true/false)
        autoplaySpeed: 0, // Скорость автоматической прокрутки
        pauseOnFocus: true, // Пауза в фокусе (true/false)
        pauseOnHover: true, // Пауза при наведении (true/false)
        pauseOnDotsHover: true, // Пауза при наведении на точки (true/false)
        ...
        centerMode: false, // Центрирует активный слайд (true/false)
    ...
    /* События слайдера */
 /*    $('.slider').on('beforeChange', function(event, skick, currentSlide, nextSlide){
        console.log(nextSlide);
    }); */
   /*  $('.slider').on('afterChange', function(event, skick, currentSlide, nextSlide){
